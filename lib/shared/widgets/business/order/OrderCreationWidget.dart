...
class OrderCreationWidget extends StatefulWidget {
  final String id;

  const OrderCreationWidget({Key key, this.id}) : super(key: key);


  @override
  State<OrderCreationWidget> createState() => OrderCreationWidgetState(id);
}

class OrderCreationWidgetState extends State<OrderCreationWidget> {
  final String id;
  ...
  OrderCreationWidgetState(this.id);
